...
export const metadata: Metadata = {
  title: "Settings",
  description: "Configure data providers and app preferences.",
};
...
export default function SettingsPage() {
  const providers = [
    {
      label: "Stock quote",
      options: "Financial Modeling Prep · Alpha Vantage · Polygon.io · Finnhub",
    },
  ...
  return (
    <AppShell>
      <div className="px-4 md:px-8 py-10 max-w-4xl mx-auto">
        ...
        <p className="text-sm text-muted-foreground mt-1">Data providers and integration status.</p>
